...
This package includes `.nojekyll` so GitHub Pages publishes the site as plain static HTML, CSS, and JavaScript.

The `assets/images/.gitkeep` file exists only so GitHub keeps the empty image folder. You can leave it there or delete it later after adding real photos.
